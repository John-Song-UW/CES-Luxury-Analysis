...
The graph shows how average household spending per recorded item changed each month from early 2019 through early 2021, with a comparison between luxury and general consumption categories. The luxury data is presented in nominal dollars, while general spending is adjusted for inflation using CPI. The Y-axis represent unadjusted transaction values, calculated as weighted means at the household level.The vertical dashed line at January 2020 marks the initial breakout of COVID-19 in the United States.
...
[**GitHub: UCC-to-CPI Mapping Table**](https://github.com/John-Song-UW/your-repo/blob/main/ucc_cpi_mapping.csv)
